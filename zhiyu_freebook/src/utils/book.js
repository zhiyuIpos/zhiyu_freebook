...
export function removeAllCss(href){
  removeCss(`${process.env.VUE_APP_EPUB_URL}/theme/theme_default.css`)
  removeCss(`${process.env.VUE_APP_EPUB_URL}/theme/theme_eye.css`)
  removeCss(`${process.env.VUE_APP_EPUB_URL}/theme/theme_gold.css`)
  removeCss(`${process.env.VUE_APP_EPUB_URL}/theme/theme_night.css`)
}
